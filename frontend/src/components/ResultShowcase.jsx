...
function formatScoreValue(score) {
  return score === null || score === undefined ? "未定" : score;
}
        ...
        <div className="match-detail-header">
          <div className="match-detail-main-row">
            ...
            <div className="match-detail-score">
              <span>{formatScoreValue(data.home_score)}</span>
              <span className="score-divider">:</span>
              <span>{formatScoreValue(data.away_score)}</span>
            </div>
            ...
            <div className="goal-list">
              {data.goals.map((g, idx) => (
                <div
                  key={idx}
                  className={`goal-item ${
                    g.team === data.home_team ? "is-home" : "is-away"
                  }`}
                >
